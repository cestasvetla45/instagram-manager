...
- Instagram CDN video URLs expire after a while, so download reels reasonably
  soon after scraping. The `Video` attachment in Airtable is fetched by Airtable
  at save time, so that copy persists even after the CDN link dies.
- Respect Instagram's terms and the rate limits / quota of your RockSolidAPIs plan.
  The daily refresh re-scrapes every tracked reel, so watch your request budget
  if you track a lot of reels.
